    ...
    <div className="flex flex-col h-screen bg-[#F9F8F4] text-[#1D1D1B] overflow-hidden">
      ...
      <nav className="flex justify-between items-center px-10 py-6 border-b border-[#1D1D1B]/10 bg-white z-10">
        ...
        <div className="flex space-x-8 text-xs uppercase tracking-editorial font-sans font-medium">
          ...
          <a href="#" className="opacity-40 hover:opacity-100 transition-opacity">Settings</a>
        </div>
            ...
            <div className="max-w-2xl">
              ...
              >
                <form onSubmit={createProduct} className="space-y-8">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className="w-full pl-6 py-2 border-b border-[#1D1D1B]/10 bg-transparent font-sans text-xl focus:outline-none focus:border-[#1D1D1B]"
                        placeholder="0.00"
                      />
                    </div>
                  </div>
                  ...
                  >
                    {creatingProduct ? <Loader2 className="animate-spin w-4 h-4" /> : '+ Post to Catalog'}
                  </button>
                  {needsOnboarding && (
                ...
                {lastProduct && (
                  ...
                  >
                    ...
                    Archive Entry Created: "{lastProduct.productName}"
                  </motion.div>
                )}
              </motion.div>
            </div>
